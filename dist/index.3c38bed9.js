 ...
 */ /* Edited by Codrops: 3dtranslate instead of translateX and translateY, removed perspective and backface-visibility hidden*/ (function(root, factory) {
   ...
   */ this.bindMethods();
    ...
    Dragdealer.prototype = {
        ...
        applyDefaults: function(options) {
            for(var k in this.defaults)if (!options.hasOwnProperty(k)) options[k] = this.defaults[k];
            return options;
        },
        ...
        calculateStepRatios: function() {
            var stepRatios = [];
            if (this.options.steps > 1) for(var i = 0; i <= this.options.steps - 1; i++)stepRatios[i] = i / (this.options.steps - 1);
            return stepRatios;
        },
        ...
        callTargetCallback: function() {
            if (typeof this.options.callback == "function") this.options.callback.call(this, this.value.target[0], this.value.target[1]);
        },
        ...
        renderHandlePosition: function() {
            ...
            if (this.options.css3 && StylePrefix.transform) {
                if (this.options.horizontal) transform += "translate3d(" + this.offset.current[0] + "px, 0, 0)";
                if (this.options.vertical) transform += " translate3d(0, " + this.offset.current[1] + "px, 0)";
        ...
        getClosestStep: function(value) {
            var k = 0;
            var min = 1;
            for(var i = 0; i <= this.options.steps - 1; i++)if (Math.abs(this.stepRatios[i] - value) < min) {
   ...
   */ get: function(obj) {
    ...
    function getPrefixedStylePropName(propName) {
        ...
        for(var i = 0; i < domPrefixes.length; i++){
            if (elStyle[domPrefixes[i] + propName] !== undefined) return domPrefixes[i] + propName; // Is supported with prefix
        }
    }
    return Dragdealer;
});

//# sourceMappingURL=index.3c38bed9.js.map
