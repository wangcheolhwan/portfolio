$(document).ready(function() {
    ...
    function slideBnr1() {
        ...
        for(var i = 1; i <= ln; i++)if (i == 1) $("#sub1 .page").append("<li class='select'></li>");
        else $("#sub1 .page").append("<li></li>");
        function auto() {
            n++;
            if (n >= ln) {
                $("#main .slide").animate({
    ...
    function slideBnr2() {
        ...
        lw = Number(100 / (ln + 1));
        console.log("lw" + lw);
        $("section#sub2 .cont").css({
            "width": sw + "%"
        });
        $("section#sub2 .cont > div").css({
            "width": lw + "%"
        });
        ...
        function auto() {
            ...
            if (n >= ln) {
                ...
                n = 0;
            } else $("section#sub2 .cont").animate({
                "left": -n * 100 + "%"
            }, 300);
        }
        function autoPlay() {
    ...
    function sectionAnimate() {
        $("section#sub2 .cont > div ul li").hover(function() {
            $(this).addClass("slide");
        }, function() {
    ...
    function slideBtn() {
        ...
        function auto() {
            n++;
            if (n > 3) {
                $("section#content1 .cont1 .bbox").animate({
                    "left": -n * bw + "px"
                }, 300, function() {
                    $("section#content1 .cont1 .bbox").css({
                        "left": 0
                ...
                n = 0;
            } else $("section#content1 .cont1 .bbox").animate({
                "left": -n * bw + "px"
            }, 300);
        }
        ...
        $("section#content1 .cont1").hover(function() {
            clearInterval(timer1);
        }, function() {
    ...
    function slideBtn2() {
        ...
        $("section#content2 .cont1 .bbox").css({
            "width": bw * (ln + 1) + "px"
        });
        ...
        function auto() {
            n++;
            if (n >= ln) {
                $("section#content2 .cont1 .bbox").animate({
                    "left": -n * bw + "px"
                }, 300, function() {
                    $("section#content2 .cont1 .bbox").css({
                        "left": 0
                ...
                n = 0;
            } else $("section#content2 .cont1 .bbox").animate({
                "left": -n * bw + "px"
            }, 300);
        }
        ...
        $("section#content2 .cont1").hover(function() {
    ...
    function slideBtn3() {
        if ($(window).width() < 800) {
            ...
            $(window).resize(function() {
                ...
                var lw = ww / 2 + 56;
                var sw = lw * ln * 2;
                $("section#content4 .wrap ul li").css({
                    "width": lw + "px"
                });
                $("section#content4 .wrap ul").css({
                    "width": sw + 10 + "px"
                });
            });
        ...
        function auto() {
            n++;
            if (n >= ln) {
                $("section#content4 .wrap ul").animate({
                    "left": -n * lw + "px"
                }, 300, function() {
                    $("section#content4 .wrap ul").css({
                        "left": 0
                ...
                n = 0;
            } else $("section#content4 .wrap ul").animate({
                "left": -n * lw + "px"
            }, 300);
        }
        ...
        if ($(window).width() > 1280) {
            ...
            $("section#content4 .wrap").hover(function() {
    ...
    function scrollMenu() {
        ...
        $(window).scroll(function() {
            var sc = $(this).scrollTop();
            if (sc > 2800) $("#scroll li:nth-child(4)").addClass("select").siblings().removeClass();
            else if (sc > 1800) $("#scroll li:nth-child(3)").addClass("select").siblings().removeClass();
            else if (sc > 800) $("#scroll li:nth-child(2)").addClass("select").siblings().removeClass();
            else $("#scroll li:nth-child(1)").addClass("select").siblings().removeClass();
        });
    }
    scrollMenu();
    function scrollMenu2() {
        $(window).scroll(function() {
            var sc = $(this).scrollTop();
            console.log(sc);
            if (sc > 1) $("#scroll_top .box").removeClass("hidden");
            else $("#scroll_top .box").addClass("hidden");
        });
    ...
    function reactWeb() {
        if (matchMedia("screen and (max-width: 500px)").matches) {
            ...
            $("section#content1 .cont3 .box1 ul li img").css({
                "width": "100%"
            });
            $("section#content1 .wrap").css({
                "width": "94%"
            });
            $("section#content2 .wrap").css({
                "width": "94%"
            });
            $("section#content3 .wrap").css({
                "width": "94%"
            });
            $("section#content4 .wrap").css({
                "width": "94%"
            });
            $("section#content3 .cont3").css({
                "width": "100%"
            });
            ...
            $("section#content1 .cont3 .box1 ul li img").css({
                "width": "calc((800px / 5) - 12px)",
                "height": "130px"
            });
            $("section#content1 .cont1 .box").css({
                "width": "auto"
            });
            $("section#content1 .cont1 .box1 img").attr("src", "./images/main_noimg.jpg");
            $("section#content2").css({
                "height": "auto"
            });
            $("section#content2 .cont1").css({
                "display": "none"
            });
            $("section#content2 .cont2").css({
                "flex-direction": "row",
                "height": "auto",
                "margin": "0 auto",
                "width": "80%"
            });
            $("section#content2 .cont2 .box1").css({
                "margin-top": "0"
            });
            $("section#content2 .cont2 img").css({
                "max-width": "100%"
            });
            $("section#content2 .cont3").css({
                "flex-wrap": "wrap",
                "width": "80%",
                "height": "100%",
                "margin": "0 auto",
            ...
            $("section#content2 .cont3 > div").css({
                "width": "calc(100% / 4 - 30px)"
            });
            $("section#content2 .cont3 .box2").css({
                "order": "1"
            });
            $("section#content2 .cont3 img").css({
                "width": "100%",
                "height": "120px"
            });
            $("section#content3 .wrap").css({
                "background": "url(../images/section4_cont3_bg.png) no-repeat right -90px bottom"
            });
            $("section#content3 .cont1 ul li img").css({
                "max-width": "100%",
                "min-width": "60px"
            });
            $("section#content3 .cont2").css({
                "width": "calc(100%/2)"
            });
            $("section#content3 .cont3").css({
                "width": "calc(100%/2)"
            });
            $("section#content3 .cont3 span").css({
                "left": "40%"
            });
            $("section#content4").css({
                "border": "none"
            });
            $("section#content4 .wrap").css({
                "width": "1024px",
            ...
            $("section#content4 .blank").css({
                "display": "none"
            });
            $("section#content4 .wrap ul li").css({
                "border": "1px solid #dadada"
            });
            $("section#content4 .prev").css({
                "display": "none"
            });
            $("section#content4 .next").css({
                "display": "none"
            });
            $("section#content4 .slide li").css({
                "display": "block"
            });
            $("footer").css({
        ...
        $(window).resize(function() {
            if ($(window).width() < 500) {
                ...
                $("section#content3 .wrap").css({
                    "background": "url(../images/section4_cont3_bg.png) no-repeat right 60px bottom"
                });
                $("section#content4 .prev").css({
                    "display": "block"
                });
...
//# sourceMappingURL=index.329ade98.js.map
