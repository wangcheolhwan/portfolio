$(document).ready(function() {
    function hoverBtn1() {
        $("header .top_menu .box > li").hover(function() {
    ...
    function scrollHeader() {
        $(window).scroll(function() {
            ...
            if (sc > sv) $("#scroll_top").addClass("active");
            else if (sc > 0) {
                $("header").css({
                    "background": "#fff",
    ...
    function intervalClick() {
        ...
        function clickBtn() {
            ...
            if (n > 3) {
                ...
                n = 1;
            } else $("section#main_visual .inner1 .cont1 .box1 ul li:nth-child(" + n + ")").click();
        }
    ...
    function rotateBtn1() {
        $(".rotate").parent().hover(function() {
            if ($(window).width() > 1024) $(this).children(".rotate").addClass("hover");
        }, function() {
            if ($(window).width() > 1024) $(this).children(".rotate").removeClass("hover");
        });
    }
    ...
    function slideBnr1() {
        ...
        function next() {
            n++;
            if (n >= ln) {
                $("section#main_visual .inner1 .cont4 .box2 .table1").animate({
                    "top": -n * lh + "px"
                }, function() {
                    $("section#main_visual .inner1 .cont4 .box2 .table1").css({
                        "top": "0"
                    });
                });
                n = 0;
            } else $("section#main_visual .inner1 .cont4 .box2 .table1").animate({
                "top": -n * lh + "px"
            });
        }
        $("section#main_visual .inner1 .cont4 .box2 .table2 .content3 > div .next").click(function() {
            ...
            $("section#main_visual .inner1 .cont4 .box2 .table2 .content2 .bar").animate({
                "left": -(80 - n * 20) + "%"
            }, 300);
        });
        function prev() {
        ...
        $("header .wrap > i").click(function() {
            if ($(window).width() > 1025) {
                if (btn) {
                    ...
                    $("header .logo a img:first-child").css({
                        "display": "none"
                    });
                    $("header .logo a img.active").css({
                        "display": "block"
                    });
                    $("body").css({
                        "overflow-y": "hidden"
    ...
    function mobileMenu() {
        $("section#pc_menu .wrap .inner .cont1 > li").hover(function() {
    ...
    function hoverBtn2() {
        ...
        $("section#main_research .cont2 ul li").on("mouseover", function(event1) {
        ...
        $("section#main_research .cont2 ul li").on("mouseleave", function(event1) {
            if ($(window).width() > 1024) {
                $(this).children("div").css({
                    "border-color": "#e5e5e5"
                });
    ...
    hoverBtn2();
    function rotateBtn2() {
        $("section#main_research .cont2 ul li").hover(function() {
            if ($(window).width() > 1024) $(this).find("i").addClass("hover");
        }, function() {
            if ($(window).width() > 1024) $(this).find("i").removeClass("hover");
        });
    }
    rotateBtn2();
    function rotateBtn3() {
        $("section#main_fund .wrap .inner1 a").hover(function() {
            if ($(window).width() > 1024) $(this).animate({
                rotate: "-180deg"
            }, 300);
        }, function() {
            if ($(window).width() > 1024) $(this).animate({
    ...
    function slideToggleBtn() {
        ...
        //		});
        $("section#main_fund .wrap .inner2 ul li .cont1").click(function() {
            $(this).parent().siblings().find(".cont2").css({
                "display": "none"
            });
            $(this).next().slideDown(200);
            $("section#main_fund .wrap .inner2 ul li").removeClass("active");
    ...
    function slideBar() {
        $("section#main_community .wrap .inner1 .cont1 .table1 .content3 i.next").click(function() {
            ...
            $("section#main_community .wrap .inner1 .cont1 .table1 .content2 .bar").animate({
                "left": -(100 - ln * 100 / 4) + "px"
            });
            ...
            $("section#main_community .wrap .inner2 .cont2 img").css({
                "opacity": "0.5"
            }).stop().attr("src", "./images/main_community_img" + ln + ".png").animate({
                "opacity": "1"
            }, 500);
        });
    ...
    function locationAd() {
        $(window).resize(function() {
            if ($(this).width() < 1024) {
                ...
                $(".swiper-horizontal>.swiper-pagination-bullets, .swiper-pagination-bullets.swiper-pagination-horizontal, .swiper-pagination-custom, .swiper-pagination-fraction").offset({
                    top: top1 + top2
                });
                $("section#main_research .cont1 .area1 a.detail").offset({
                    top: top1 + top2 + 50
                });
            } else return false;
        });
...
//# sourceMappingURL=index.c4f9936a.js.map
